...
public class Level {
	...
	public void levelOne() { //Creates the first level of the game
		...
		platform1 = new Tile(330+32*4,394-32*2,32*12,32,Color.DARK_GRAY);//creates a platform with scale to the character
		platform2 = new Tile(330+32*20,494,32*12,32,Color.DARK_GRAY);//creates a platform with scale to the character
		platform3 = new Tile(330,594,32*12,32,Color.DARK_GRAY);//creates a platform with scale to the character
